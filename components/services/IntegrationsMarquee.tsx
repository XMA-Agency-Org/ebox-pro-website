...
const NoonIcon = () => (
  <Image src={NoonLogo} alt="Noon Logo" width={40} height={40} className="w-10 h-10" />
);
...
const MagentoIcon = () => (
  ...
  >
    <path
      fill="#f26322"
      d="M64 0L12.8 28.8v70.4L25.6 108V38.4L64 16l38.4 22.4V108l12.8-8.8V28.8zm0 32L38.4 48v60.8l12.8 8V57.6L64 48l12.8 9.6v59.2l12.8-8V48z"
    ></path>
  </svg>
);
    ...
    <section className="section-padding bg-surface-subtle">
      <div className="container-wide">
        ...
        >
          ...
          <h2 className="text-display-md text-foreground">Supported Platforms</h2>
        </motion.div>
      </div>

      {/* Marquee */}
      <Marquee pauseOnHover speed={25} className="mt-0 sm:mt-0">
        {integrations.map((integration) => {
          const Icon = integration.icon;
          return (
            <div
              key={integration.name}
              className="flex flex-col items-center gap-3 mx-6 px-8 py-6 rounded-xl bg-surface border border-border hover:border-primary/30 transition-colors"
            >
              <Icon />
