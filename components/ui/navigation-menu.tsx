...
const navigationMenuTriggerStyle = cva(
  ...
  data-[state=open]:hover:bg-primary data-[state=open]:text-white data-[state=open]:focus:bg-primary data-[state=open]:bg-primary/50 \
...
function NavigationMenuViewport({
  ...
  return (
    <div
      className={cn(
        "absolute top-full left-0 isolate z-50 flex justify-start w-full"
      )}
    >
